...
public class VNPayConstant {
    public static final String VNP_SECRETKEY = "LYBVGBUB3PG4N7HJVO9N4HOLUQYGIE0C";
    public static final String VNP_TMNCODE = "E6T2KFD0";
    ...
    public static final String VNP_RETURN_URL = "https://localhost:9999/payment";
