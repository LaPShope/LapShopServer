...
public class AccountController {
    ...
    public ResponseEntity<DataResponse<?>> resetPassword(@RequestBody ResetPasswordRequest request) {
        ResetPasswordReponse response = accountService.changePassword(request);

        return ResponseEntity.status(HttpStatus.CREATED)
                .body(DataResponse.<ResetPasswordReponse>builder()
                        .success(true)
